...
public class AHMetaTileEntities {
    ...
    public static final MetaTileEntityAdvancedTransformer[] HI_POWER_TRANSFORMER = new MetaTileEntityAdvancedTransformer[GTValues.V.length -
            1];
    public static final MetaTileEntityAdvancedTransformer[] EXTREME_POWER_TRANSFORMER = new MetaTileEntityAdvancedTransformer[GTValues.V.length -
            1];
    ...
    public static void partsCEu() {
        ...
        for (int i = 0; i < EnergyHatchEndPos; i++) {
            ...
            if (enabledLowTier && i < GTValues.LuV) {
                SUBSTATION_ENERGY_INPUT_102A_LOW[i] = registerMetaTileEntity(id + i,
                        new MetaTileEntityAdvancedSubstationEnergyHatch(
                                ahId("substation_hatch.input_1024a." + voltageName), i, 1024, false));
                SUBSTATION_ENERGY_OUTPUT_1024A_LOW[i] = registerMetaTileEntity(id + 14 + i,
                        new MetaTileEntityAdvancedSubstationEnergyHatch(
                                ahId("substation_hatch.output_1024a." + voltageName), i, 1024, true));
            }
        ...
        ROTOR_HOLDERS_HI[0] = registerMetaTileEntity(id,
                new MetaTileEntityRotorHolder(ahId("rotor_holder.uhv"), GTValues.UHV));
        if (GregTechAPI.isHighTier()) {
            for (int i = 1; i < ROTOR_HOLDERS_HI.length; i++) {
                ROTOR_HOLDERS_HI[i] = registerMetaTileEntity(id + i,
                        new MetaTileEntityRotorHolder(ahId("rotor_holder." + GTValues.VN[i + 9].toLowerCase()), 9 + i));
            }
        }
        ...
        for (int i = 0; i < rotorEndPos; i++) {
            ...
            POWER_ENHANCED_ROTOR_HOLDERS[i] = registerMetaTileEntity(id + i,
                    new MetaTileEntityPowerEnhancedRotorHolder(ahId("rotor_holder.enhanced.power." + voltage), v));
            // Efficiency Enhanced: 25170-25178
            EFFICIENCY_ENHANCED_ROTOR_HOLDERS[i] = registerMetaTileEntity(id + 9 + i,
                    new MetaTileEntityEfficiencyEnhancedRotorHolder(ahId("rotor_holder.enhanced.efficiency." + voltage),
                            v));
            // Advanced 25179-25187
            ADVANCED_ROTOR_HOLDERS[i] = registerMetaTileEntity(id + 18 + i,
                    new MetaTileEntityAdvancedRotorHolder(ahId("rotor_holder.advanced." + voltage), v));
        }
    }
     ...
     * }
     * 
     * if (enabledParallel1024) ADVANCED_PARALLEL_HATCH_1024 = registerMetaTileEntity(25000, new
     * MetaTileEntityAdvancedParallelHatch(ahId(String.format("advanced_parallel_hatch.%s", GTValues.VN[9])), 9));
     * if (enabledParallel4096) ADVANCED_PARALLEL_HATCH_4096 = registerMetaTileEntity(25001, new
     * MetaTileEntityAdvancedParallelHatch(ahId(String.format("advanced_parallel_hatch.%s", GTValues.VN[10])), 10));
     * if (enabledParallel16384) ADVANCED_PARALLEL_HATCH_16384 = registerMetaTileEntity(25002, new
     * MetaTileEntityAdvancedParallelHatch(ahId(String.format("advanced_parallel_hatch.%s", GTValues.VN[11])), 11));
     * if (enabledParallel65536) ADVANCED_PARALLEL_HATCH_65536 = registerMetaTileEntity(25003, new
     * MetaTileEntityAdvancedParallelHatch(ahId(String.format("advanced_parallel_hatch.%s", GTValues.VN[12])), 12));
     * if (enabledParallel262144) ADVANCED_PARALLEL_HATCH_262144 = registerMetaTileEntity(25004, new
     * MetaTileEntityAdvancedParallelHatch(ahId(String.format("advanced_parallel_hatch.%s", GTValues.VN[13])), 13));
     * if (enabledParallel1048576) ADVANCED_PARALLEL_HATCH_1048576 = registerMetaTileEntity(25005, new
     * MetaTileEntityAdvancedParallelHatch(ahId(String.format("advanced_parallel_hatch.%s", GTValues.VN[14])), 14));
     * }
     */
}
