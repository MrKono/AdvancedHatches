...
public class MetaTileEntityAdvancedRotorHolder extends MetaTileEntityRotorHolder {
    ...
    public MetaTileEntityAdvancedRotorHolder(ResourceLocation metaTileEntityId, int tier) {
        super(metaTileEntityId, tier);
        this.inventory = new InventoryRotorHolder();
        this.maxSpeed = 5 * (2000 + 1000 * tier);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityAdvancedRotorHolder(metaTileEntityId, getTier());
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        if (TooltipHelper.isShiftDown() && TooltipHelper.isCtrlDown()) {
            tooltip.add(I18n.format("advancedhatches.machine.rotor_holder.efficiency.tooltip", 100));
            tooltip.add(I18n.format("advancedhatches.machine.rotor_holder.power.tooltip", 100));
            tooltip.add(I18n.format("advancedhatches.machine.rotor_holder.speed.tooltip", 400));
        }
    }
        ...
        if (!this.getWorld().isRemote) {
            ...
            if (controller != null && controller.isActive()) {
                if (this.currentSpeed < this.maxSpeed) {
                    this.setCurrentSpeed(this.currentSpeed + 3);
                }
                ...
                this.setCurrentSpeed(Math.max(0, this.currentSpeed - 9));
            }
    ...
    public int getRotorEfficiency() {
        return inventory.getRotorEfficiency() * 2;
    }
    ...
    private class InventoryRotorHolder extends NotifiableItemStackHandler {
        ...
        public InventoryRotorHolder() {
            super(MetaTileEntityAdvancedRotorHolder.this, 1, null, false);
        }
