...
public class MetaTileEntityAdvancedParallelHatch extends MetaTileEntityParallelHatch {
    ...
    public MetaTileEntityAdvancedParallelHatch(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityAdvancedParallelHatch(this.metaTileEntityId, this.getTier());
    }
