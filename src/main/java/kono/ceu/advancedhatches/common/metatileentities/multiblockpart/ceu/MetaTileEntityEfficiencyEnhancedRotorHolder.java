...
public class MetaTileEntityEfficiencyEnhancedRotorHolder extends MetaTileEntityRotorHolder {
    ...
    public MetaTileEntityEfficiencyEnhancedRotorHolder(ResourceLocation metaTileEntityId, int tier) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityEfficiencyEnhancedRotorHolder(metaTileEntityId, getTier());
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        if (TooltipHelper.isShiftDown() && TooltipHelper.isCtrlDown()) {
            tooltip.add(I18n.format("advancedhatches.machine.rotor_holder.efficiency.tooltip", 50));
    ...
    public int getRotorEfficiency() {
        return (int) (inventory.getRotorEfficiency() * 1.5);
    }
    ...
    private class InventoryRotorHolder extends NotifiableItemStackHandler {
        ...
        public InventoryRotorHolder() {
            super(MetaTileEntityEfficiencyEnhancedRotorHolder.this, 1, null, false);
        }
